...
export function EditContentPage() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 max-w-md shadow-sm text-center">
          ...
          <p className="text-sm text-gray-500 mb-2">
            Content can only be edited when it is a{" "}
            <strong className="text-gray-700">Draft</strong> or has{" "}
            <strong className="text-gray-700">Changes Requested</strong>.
          </p>
          <p className="text-sm text-gray-400 mb-5">Current status: </p>
  ...
  const rejectionEntry = [...item.history]
    .reverse()
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Address the requested changes before resubmitting
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {imageFile && (
                    <p className="text-[10px] text-blue-600 font-medium ml-1 flex items-center gap-1">
                      <Save className="h-2.5 w-2.5" /> File selected:{" "}
                      {imageFile.name}
                    </p>
                  )}
                </div>
                  ...
                  {form.body.split("\n\n").map((paragraph, idx) => {
                    ...
                    if (paragraph.startsWith("## ")) {
                      return (
                        <h2
                          key={idx}
                          className="text-base font-bold text-gray-800 mt-5 mb-1"
                        >
                          {paragraph.replace("## ", "")}
                        </h2>
                      );
